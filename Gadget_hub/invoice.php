...
<?php  
$oid=$_GET['oid'];
$query=mysqli_query($con,"select tblorderaddresses.OrderTime,tblitem.Image,tblitem.ItemName, tblitem.ItemQty, tblitem.Weight,tblitem.ItemPrice,tblorders.ItemId,tblorders.OrderNumber, tblorders.discount_amount from tblorders 
  join tblitem on tblitem.ID=tblorders.ItemId 
...
$cnt=$cnt+1;} ?>
<tr>
  <th colspan="4" style="text-align:center">Discount Amount </th>
<td>$ <?php  echo $discount;?></td>
</tr>
<tr>
  <th colspan="4" style="text-align:center">Grand Total </th>
<td>$ <?php  echo $item*$grandtotal - $discount;?></td>
</tr>
</table>
