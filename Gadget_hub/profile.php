...
<head>
        <title>GadgetHub System|| Profile</title>
...
.contact_form_area form .form-group {
  margin-bottom: 20px;
}

.contact_form_area form label {
  color: royalblue;
  font-weight: bold;
}

.contact_form_area form .form-control {
  width: 100%;
  padding: 15px;
...
.contact_form_area form button[name="submit"] {
  width: 100%;
...
.contact_form_area form button[name="submit"]:hover {
