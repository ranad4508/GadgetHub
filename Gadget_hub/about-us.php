...
<head>
        <title>GadgetHub System|| About Us</title>
...
?>
        		...
        		<div class="row our_bakery_image">
        			<div class="col-md-4 col-6">
        				<img class="img-fluid" src="img/our-product/product1.jpg" alt="">
        			</div>
        			<div class="col-md-4 col-6">
        				<img class="img-fluid" src="img/our-product/product2.jpg" alt="">
        			</div>
        			<div class="col-md-4 col-6">
        				<img class="img-fluid" src="img/our-product/product3.webp" alt="">
        			</div>
        		</div>
        	</div>
        </section>
