...
if (strlen($_SESSION['fosuid'] == 0)) {
  ...
  <head>
    ...
    <title>GadgetHub System|| My Order</title>
    ...
    <style>
      ...
      .cart_table_area table tr:nth-child(even) {
        background-color: #f5f5f5;
      }

      .cart_table_area table a {
        color: #1ab394;
        text-decoration: none;
      }

      .cart_table_area table a:hover {
        text-decoration: underline;
      }

      .cart_table_area .theme-btn-dash {
      ...
      .cart_table_area .theme-btn-dash:hover {
    ...
    <section class="cart_table_area p_100">
      <div class="container">
        <div class="table-responsive">
          <h4 style="color: brown;font-weight:700;text-align: center;">Your Order Detail</h4>
            ...
            <tbody>
              ...
              while ($row = mysqli_fetch_array($query)) { ?>
                <tr>
                  ...
                  <td><a href="order-detail.php?orderid=<?php echo $row['Ordernumber']; ?>" class="btn theme-btn-dash">View
                      Details</a></td>
                </tr>
                <?php $cnt = $cnt + 1;
              } ?>
