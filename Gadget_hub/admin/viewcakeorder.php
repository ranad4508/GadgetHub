...
if (strlen($_SESSION['fosaid'] == 0)) {
  ...
  if (isset($_POST['submit'])) {
    ...
    $query = mysqli_query($con, "insert into tblordertracking(OrderId,remark,status) value('$oid','$remark','$ressta')");
            ...
            <div class="col-lg-12">
              <div class="ibox">
                ...
                <div class="ibox-content">
                  ...
                  while ($row = mysqli_fetch_array($ret)) {
                    ...
                    <div class="row">
                        ...
                        <table border="1" class="table table-bordered mg-b-0">
                          ...
                          <tr>
                            ...
                            <td>
                              ...
                              if ($row['OrderFinalStatus'] == "Order is on the way") {
                                echo "Order is on the way";
                              }
                              if ($row['OrderFinalStatus'] == "Order Pickup") {
                                echo "Cake Pickup";
                              }
                      ...
                      <div class="col-6" style="margin-top:2%">
                        <?php
                        $query = mysqli_query($con, "SELECT tblitem.Image, tblitem.ItemName, tblitem.ItemDes, tblitem.ItemPrice, tblitem.ItemQty, tblorders.ItemId, tblorders.Mode FROM tblorders JOIN tblitem ON tblitem.ID=tblorders.ItemId WHERE tblorders.IsOrderPlaced=1 AND tblorders.OrderNumber='$oid'");
                          ...
                          <tr>
                            ...
                            <td>
                              <select name="status" class="form-control wd-450" required="true">
                                ...
                                <option value="Cake being Prepared">Order is on the way</option>
                                <option value="Cake Pickup">Order Pickup</option>
                                <option value="Cake Delivered">Order Delivered</option>
                              </select>
                            </td>
                          </tr>
                          <tr align="center">
                  ...
                  <?php if ($orserstatus != "") {
                    $ret = mysqli_query($con, "select tblitemtracking.OrderCanclledByUser,tblitemtracking.remark,tblitemtracking.status as fstatus,tblitemtracking.StatusDate from tblitemtracking where tblitemtracking.OrderId ='$oid'");
                    $cnt = 1;
                    ...
                    <table id="datatable" class="table table-bordered dt-responsive nowrap"
                      ...
                      <tr align="center">
                        <th colspan="4">Order Tracking History</th>
                      </tr>
                      <tr>
                        <th>#</th>
                        <th>Remark</th>
