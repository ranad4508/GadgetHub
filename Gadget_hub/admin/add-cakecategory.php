...
if (strlen($_SESSION['fosaid']) == 0) {
  ...
  if (isset($_POST['submit'])) {
    ...
    $checkQuery = mysqli_query($con, "SELECT * FROM tblcategory WHERE CategoryName = '$category'");
            ...
            $(document).ready(function () {
                ...
                $("#form").steps({
                    ...
                    onStepChanged: function (event, currentIndex, priorIndex) {
                        ...
                        // Suppress (skip) "Warning" step if the user is old enough and wants to go to the previous step.
                    ...
                    onFinishing: function (event, currentIndex) {
                        ...
                        // At this point, it's recommended to do an overall check (ignoring only disabled fields)
