...
if(isset($_POST['submit']))
  {
   ...
   $itempic=$_FILES["itemimages"]["name"];
    $query=mysqli_query($con, "update tblitem set CategoryName='$fcat',ItemName='$itemname',ItemPrice='$price',ItemDes='$description',ItemQty='$quantity', color='$color' where ID='$cid'" );
    if ($query) {
...
<head>
    ...
    <title>GadgetHub System||Edit Item</title>
    ...
    echo $msg;
                                    ...
                                    <fieldset>
                                            ...
                                            <div class="form-group row"><label class="col-sm-2 col-form-label">Color:</label>
                                                <div class="col-sm-10"><input type="text" class="form-control" name="color" required="true"></div>
                                            </div>
...
<select name="weight" class="form-control white_bg">
    ...
    <option value="500 gm">500 gm</option>
                                           ...
                                           <div class="form-group row"><label class="col-sm-2 col-form-label">Item Category:</label>
                                                <div class="col-sm-10">
                                                    <select class="form-control white_bg" name='itemcategory' >
