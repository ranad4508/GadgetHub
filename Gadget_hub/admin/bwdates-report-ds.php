...
<head>
    ...
    <title>GadgetHub System|| Between Dates Report</title>
...
<form name="bwdatesreport"  action="bwdates-reports-details.php" method="post"> 
                ...
                <input type="radio" name="requesttype" value="">Not Confirmed Order
                  ...
                  <input type="radio" name="requesttype" value="Order Confirmed">Confirmed Order
                    <input type="radio" name="requesttype" value="Order is on the way">Order is on the way
                      <input type="radio" name="requesttype" value="Item Pickup Order">Item Pickup Order
                      <input type="radio" name="requesttype" value="Item Delivered order">Item Delivered order
                                        </div>
                                    </div>
