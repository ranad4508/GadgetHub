...
if (strlen($_SESSION['fosaid'] == 0)) {
    ...
    if (isset($_POST['submit'])) {
        ...
        if (!in_array($extension, $allowed_extensions)) {
            ...
            $query = mysqli_query($con, "insert into tblitem(CategoryName,ItemName,ItemPrice,ItemDes,ItemQty, color,Weight,Image) value('$fcat','$itemname','$price','$description','$quantity',' $color','$weight','$itempic')");
            if ($query) {
                echo '<script>alert("Gadget has been added")</script>';
    ...
    <head>
        <title>GadgetHub System|| Add Item</title>
                                    ...
                                    <form id="submit" action="#" class="wizard-big" method="post" name="submit"
                                        ...
                                        <fieldset>
                                            <div class="form-group row"><label class="col-sm-2 col-form-label">Item
                                                    Category:</label>
                                                <div class="col-sm-10"><select name='itemcategory' id="itemcategory"
                                            ...
                                            <div class="form-group row"><label
                                                ...
                                                <div class="col-sm-10"><input type="text" class="form-control" name="color">
                                                </div>
                                            </div>
                                            <div class="form-group row"><label
