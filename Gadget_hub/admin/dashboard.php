...
<head>
    <title>GadgetHub System || Dashboard</title>
                    ...
                    <div class="col-lg-4">
                        <div class="ibox ">
                            <div class="ibox-title">
                                ...
                                ?>
                                <a class="text-muted text-uppercase m-b-20" href="cakebeingprepared.php"
                                    style="font-size: 20px"><strong>Order is on the way</strong></a>
                    ...
                    <div class="col-lg-4">
                        <div class="ibox ">
                            <div class="ibox-title">
                                ...
                                ?>
                                <a class="text-muted text-uppercase m-b-20" href="cake-pickup.php"
                                    style="font-size: 20px"><strong> Order Pickup</strong></a>
                    ...
                    <div class="col-lg-4">
                        <div class="ibox ">
                            <div class="ibox-title">
                                ...
                                ?>
                                <a class="text-muted text-uppercase m-b-20" href="Cake-delivered.php"
                                    style="font-size: 20px"><strong>Total Item Deliver</strong></a>
                            ...
                            <div class="ibox-content">
                                ...
                                <small>Total Item Deliver</small>
                            </div>
                        </div>
                    </div>
