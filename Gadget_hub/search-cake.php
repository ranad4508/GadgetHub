...
<head>
    <title>GadgetHub  System || Search Product</title>
        ...
        <div class="container">
            <div class="banner_text">
                ...
                <ul>
                    ...
                    <li><a href="search-cake.php">Search Product</a></li>
                </ul>
            </div>
        </div>
    </section>
    ...
    <section class="our_cakes_area p_100">
        <div class="container">
                ...
                <form method="post">
                    <div class="form-group col-md-12" style="padding-top: 20px;">
                        <input type="text" class="form-control" id="searchkey" name="searchkey"
                            placeholder="Search Cake by name" required="true">
                    </div>

                    <div class="form-group col-md-12">
                        <button type="submit" value="Search" name="search"
                            class="btn order_s_btn form-control">search</button>
                    </div>
                </form>
            </div>
            ...
            <?php if (isset($_POST['search'])) {
                ...
                ?>
                <h3 align="center">Search Result against keyword "
                    <?php echo $searchkey; ?>"
                </h3>
                <hr />
                <div class="cake_feature_row row">
                    ...
                    $ret = mysqli_query($con, "select * from tblitem  where ItemName like '%$searchkey%'");
