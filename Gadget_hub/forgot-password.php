...
<head>
        <title>GadgetHub System|| Forgot Password</title>
...
.contact_form_area .btn.register-btn {
  background-color: #4caf50;
}

.contact_form_area .btn.register-btn:hover {
  background-color: #45a049;
}

.contact_form_area .btn.register-btn:active {
  background-color: #39823c;
}

.contact_form_area .btn.register-btn:focus {
